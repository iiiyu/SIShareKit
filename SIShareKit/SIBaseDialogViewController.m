...
@interface SIBaseDialogViewController ()
...
//    self.backgroundView = [[UIView alloc] initWithFrame:[UIScreen mainScreen].applicationFrame];
...
- (CGRect)fitOrientationFrame
{
    ...
    if (UIInterfaceOrientationIsLandscape(orientation)) {
        return CGRectMake(kPadding, kPadding * 3, self.view.frame.size.height - kPadding * 2, 
