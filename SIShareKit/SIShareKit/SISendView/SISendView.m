...
@implementation SISendView

@synthesize contentText;
@synthesize contentImage;
@synthesize delegate;

#pragma mark - SISendView Life Circle
...
//        [engine setDelegate:self];
        ...
        [panelImageView setImage: [[UIImage imageNamed: @"tx-send-bg.png"] stretchableImageWithLeftCapWidth: 18 topCapHeight: 18]];
...
#pragma mark - SISendView Private Methods
...
//                                                contentImageView.center.y - contentImageView.frame.size.height / 2)];
        ...
        [panelImageView setImage: [UIImage imageNamed: @"tx-send-bg-land.png"]];
...
//                                                contentImageView.center.y - contentImageView.frame.size.height / 2)];
        ...
        [panelImageView setImage: [UIImage imageNamed: @"tx-send-bg.png"]];
...
#pragma mark - SISendView Public Methods
